...
export const metadata = {
  title: "Day trader — a single session · Mesocosm",
};
...
export default function TradingShowcasePage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <header className="pb-8 border-b border-line">
        ...
        <p className="mt-4 text-lg text-ink-2 leading-relaxed max-w-prose">
          $100,000 cash, six tickers, one streaming news wire, five decisions
          across a market day. We show you the request we send, what the
      ...
      <section className="mt-16 pt-10 border-t border-line">
        ...
        <p className="mt-3 text-ink-2 max-w-prose leading-relaxed">
          Portfolio on the left, the model's turn-by-turn reasoning in the
          centre, the news wire on the right. Each turn: news lands, the
