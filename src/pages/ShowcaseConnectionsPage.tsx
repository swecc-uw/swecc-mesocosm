...
export function ShowcaseConnectionsPage() {
  useEffect(() => {
    document.title = "Connections — a thinking room · Mesocosm";
  }, []);
    ...
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <header className="pb-8 border-b border-line">
        ...
        <p className="mt-4 text-lg text-ink-2 leading-relaxed max-w-prose">
          A model is handed a 4×4 board of sixteen words and asked to find four hidden categories. We show you the request we make, the response we
      ...
      <section className="mt-16 pt-10 border-t border-line">
        ...
        <p className="mt-3 text-ink-2 max-w-prose leading-relaxed">
          One turn per vertical section: the state of the board, the model&apos;s thinking label, its typed reasoning, and the action it commits.
